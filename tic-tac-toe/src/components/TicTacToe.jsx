...
export default function TicTacToe() {
    ...
    return (
        <div className='flex flex-col items-center min-h-screen bg-emerald-950 text-white pt-12'>
          <div className="flex-grow">
            <Board playerTurn={playerTurn} tiles={tiles} onTileClick={handleTileClick} strikeClass={strikeClass} />
            <GameOver gameState={gameState} className="mb-4" />
          </div>
          <Reset gameState={gameState} onReset={handleReset} className='' />
        </div>
      )
    }      
